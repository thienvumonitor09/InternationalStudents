<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/internationalGlobal2subpage.master" CodeFile="xxglobal2ApplicationFormTest.aspx.cs" Inherits="InternationalStudents_Standardized_xxglobal2ApplicationFormTest" %>
...
<script type="text/javascript">
    ...
    <div class="divHideTR">
        <p>Transfer students, please complete this <a href="/internationalsa/Transfer_IN.pdf" target="_blank">form</a></p>
    </div>
    <script type="text/javascript">
...
<br /><br />
   ...
   <div id="eWhatMajor" class="divError" runat="server"></div>
    ...
    <div class="radFERPA">    
        <input type="radio" id="ferpaYes" value="yes" name="ferpa" runat="server" />I authorize CCS to release academic, financial and immigration status information to my sponsor, educational agency and/or parents.
        <br /><strong>Review the <a href="http://www.ccs.spokane.edu/Forms/Student-services/ccs-40-200.aspx" target="_blank">FERPA (Family Educational Rights and Privacy Act) authorization</a></strong><br /><br />
        <input type="radio" id="ferpaNo" value="no" name="ferpa" runat="server" />I decline to authorize release of any information.
    </div>
    ...
    <br /><br />
        ...
        <ol>
            ...
            <li>Purchase <b><a href="http://www.lewermark.com/ccspokane" target="_blank">health insurance</a></b> while enrolled at CCS</li>
