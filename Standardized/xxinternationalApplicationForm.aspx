<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/internationalsubpage.master" CodeFile="xxinternationalApplicationForm.aspx.cs" Inherits="InternationalStudents_Standardized_xxinternationalApplicationForm" Debug="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" Runat="Server">
    ...
    <h1><b>International Student APPLICATION</b></h1>

    <fieldset id="current" runat="server" visible="true" width="100%" title="application form">
        ...
        <!--
        <p>
        <label for="txtNativeLanguage" id="nativeLanguage" class="fieldTitle">Native Language</label><br />
        <asp:TextBox ID="txtNativeLanguage" runat="server" MaxLength="100"></asp:TextBox>
        </p>
        -->
        <p>
        <label for="radEnglishAbility" id="englishAbility" class="fieldTitle">English Ability</label><br />
  ...
  <!--      <input type="checkbox" name="chkParentsContact" runat="server" id="chkParentsContact" class="pContact" /> -->
        </p>
        <p>
        ...
        <!--
        <p>
        <label for="txtParentsFAX" id="parentsFAX" class="fieldTitle">Parent's FAX</label><br />
       <asp:TextBox ID="txtParentsFAX" Width="150px" runat="server"></asp:TextBox>
        </p>
        <div id="eParentFAX" class="divError" runat="server"></div>
        -->
        <p>
       ...
       <asp:TextBox ID="txtParentsEmail" Width="200px" runat="server"></asp:TextBox>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $('.pContact').change(function () {
                    $('.divHideParentAddr').toggle();
                });
            });
    </script>
 ...
 <!--   
     <table width="100%">
            <tr>
                <td style="width:75%"><label for="radRelativeInUS" id="labelRelativeInUS">Do you have a relative in the U.S.? If so, enter their contact information</label></td>
                <td style="width:25%">
                <input type="radio" name="radRelativeInUS" id="relativeUS_0" runat="server" class="relativeInUS" value="yes" /> Yes
                <input type="radio" name="radRelativeInUS" id="relativeUS_1" runat="server" class="relativeInUS" value="no" /> No
                </td>
            </tr>
         
        </table>
    <div class="divHideRelative">
        <p>
        <label for="txtRelativeName" id="relativeName" class="fieldTitle">Relative's Name</label><br />
        <asp:TextBox ID="txtRelativeName" runat="server" Width="300px"></asp:TextBox>
        </p>

        <p>
        <label for="txtRelativeRelationship" id="relativeRelationship" class="fieldTitle">Relationship to you</label><br />
        <asp:TextBox ID="txtRelativeRelationship" runat="server" Width="300px"></asp:TextBox>
        </p>

        <p>
        <label for="txtRelativeAddress" id="relativeAddress" class="fieldTitle">Relative's Street Address</label><br />
        <asp:TextBox ID="txtRelativeAddress" runat="server" Width="400px"></asp:TextBox>
        </p>

        <p>
        <label for="txtRelativePhone" id="relativePhone" class="fieldTitle">Relative's Phone</label><br />
        <asp:TextBox ID="txtRelativePhone" Width="150px" runat="server"></asp:TextBox>
        </p>
        <div id="eRelativePhone" class="divError" runat="server"></div>
        <p>
        <label for="txtRelativeFAX" id="relativeFAX" class="fieldTitle">Relative's FAX</label><br />
       <asp:TextBox ID="txtRelativeFAX" Width="150px" runat="server"></asp:TextBox>
        </p>
        <div id="eRelativeFAX" class="divError" runat="server"></div>
        <p>
        <label for="txtRelativeEmail" id="relativeEmail" class="fieldTitle">Relative's Email</label><br />
       <asp:TextBox ID="txtRelativeEmail" Width="200px" runat="server"></asp:TextBox>
        </p>
        <div id="eRelativeEmail" class="divError" runat="server"></div>
        </div>
        <script type="text/javascript">
            $("input:radio[name='ctl00$ContentHolder$radRelativeInUS']").click(function () {
                var val = $("input:radio[name='ctl00$ContentHolder$radRelativeInUS']:checked").val();
                // alert("value: " + val);
                if (val == "yes") {
                    $('.divHideRelative').show();
                }
                else {
                    $('.divHideRelative').hide();
                }
            });
        </script>
-->
        ...
        <!--
        <p>
        <label for="txtEmergCell" id="emergCellPhone" class="fieldTitle">Emergency Contact Cell Phone</label><br />
        <asp:TextBox ID="txtEmergCell" Width="150px" runat="server"></asp:TextBox>
        </p>
        <div id="eEmergCellPhone" class="divError" runat="server"></div>
        -->
        <p>
        ...
        <!--
        <p>
        <label for="ddEmergCountry" id="Label2" class="fieldTitle">Emergency Contact Country</label><br />
        <asp:DropDownList ID="ddEmergCountry" runat="server">
             </asp:DropDownList>
        </p>

        <p><label for="radEmergencyEnglish" id="Label3">Is your Emergency Contact English Speaking?</label><br />
            <input type="radio" runat="server" name="radEmergencyEnglish" id="emergEnglish_0" value="yes" /> Yes
            <input type="radio" runat="server" name="radEmergencyEnglish" id="emergEnglish_1" value="no" /> No
        </p>
-->
        <p class="sectionHeading">Medical Information</p>
        <!--
        <p><label for="radMedical" id="labelMedical">Do you have any medical conditions or allergies?</label><br />
                <input type="radio" runat="server" name="radMedical" id="radMedical_0" class="medicalBox" value="yes" /> Yes
                <input type="radio" runat="server" name="radMedical" id="radMedical_1" class="medicalBox" value="no" /> No
        </p>
    <div class="divHideMedical">
        <p>
        <label for="txtAreaMedical" id="txtMedical" class="fieldTitle">Please describe your medical condition or allergy</label><br />
        <asp:TextBox ID="txtAreaMedical" runat="server" Columns="80" Rows="5" TextMode="MultiLine"></asp:TextBox>
        </p>
    </div>

    <script type="text/javascript">
        $("input:radio[name='ctl00$ContentHolder$radMedical']").click(function () {
            var val = $("input:radio[name='ctl00$ContentHolder$radMedical']:checked").val();
            if (val == "yes") {
                $('.divHideMedical').show();
            }
            else {
...
-->
    ...
    <script type="text/javascript">
     ...
     <p>
        ...
        <span style="font-style:italic; font-size:smaller;">(only exception is for students attending through state-sponsored programs such as SACM)</span></span>
     </p>   
 <!--       
        <asp:RadioButtonList ID="radHealthIns" runat="server" BackColor="ControlLight" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="flowBot" Width="100%">
            <asp:ListItem Value="purchase">I will purchase health insurance through CCS</asp:ListItem>
            <asp:ListItem Value="bring">I will bring my own health insurance</asp:ListItem>
        </asp:RadioButtonList>
     </p>
     -->
    ...
    <table width="100%">
        <tr>
            <td style="width:40%;"><label for="txtTOEFLschoolCode" id="schoolCode" class="testInfo">School Code</label></td>
            <td style="width:10%;"><label for="txtTOEFLscore" id="toeflScore" class="testInfo">TOEFL Score</label></td>
            <td style="width:50%;"><label for="ddTOEFLmm" id="toeflDate" class="testInfo">TOEFL Test Date</label></td>
        </tr>
        <tr>
            <td style="width:40%;"><asp:TextBox ID="txtTOEFLschoolCode" onblur="checkCode()" runat="server" Width="50px" CssClass="flowBot2" MaxLength="4"></asp:TextBox>
            <br /><span style="font-size:x-small;">SCC code: 4739 or SFCC Code: 4752</span></td>
            <td style="width:10%;"><asp:TextBox ID="txtTOEFLscore" runat="server" Width="50px" MaxLength="2" CssClass="flowBot2"></asp:TextBox></td>
            <td style="width:50%;"><asp:DropDownList ID="ddTOEFLmm" runat="server" CssClass="flowBot2">
        ...
        <tr>
            ...
            <td style="width:10%;"><label for="txtIELTSscore" id="IELTSscore" class="testInfo">IELTS Score</label></td>
            <td style="width:50%;"><label for="ddTOEFLmm" id="labelTOELF" class="testInfo">IELTS Test Date</label></td>
        </tr>
        <tr>
            <td style="width:40%;"></td>
            <td style="width:10%;"><asp:TextBox ID="txtIELTSscore" runat="server" Width="50px"></asp:TextBox></td>
            <td style="width:50%;"><asp:DropDownList ID="ddIELTSmm" runat="server">
                    <asp:ListItem Selected="True">MM</asp:ListItem>
                    <asp:ListItem>01</asp:ListItem>
                    <asp:ListItem>02</asp:ListItem>
                    <asp:ListItem>03</asp:ListItem>
    ...
    <div id="eTestScores" class="divError" runat="server"></div>
    <!--
    <p>
        <label class="testInfo"></label><br />
        <br />&nbsp;&nbsp;&nbsp;
        <label class="testInfo"></label>&nbsp;&nbsp;&nbsp;
        <label class="testInfo">
                </label>
        </p>
        <div id="eSchoolCode" class="divError"></div>
        <p>
        <label for="txtIELTSscore" id="IELTscore" class="testInfo"></label><br />
        <label class="testInfo"><asp:TextBox ID="TextBox1" runat="server" Width="50px" CssClass="flowBot2" MaxLength="4" Visible="false"></asp:TextBox></label>
        <label class="testInfo"></label>
        <label class="testInfo">
                </label>
        </p>
...
<br /><br />
    <table width="100%">
        ...
        <tr>
            ...
            <asp:ListItem Value="University Transfer">University Transfer</asp:ListItem>
   ...
   <p>
    ...
    <p><label for="radPaymentOption" id="lblPayOption" class="fieldTitle">Which payment option will you use to pay for application and placement fees? *</label><br />
        <asp:RadioButtonList ID="radPayOption" name="radPayOption" runat="server" BackColor="ControlLight" RepeatDirection="Vertical" RepeatLayout="Flow" Width="100%">
            ...
            <asp:ListItem Value="check or draft"></asp:ListItem>
    ...
    <div class="divHideCC">
        <span style="font-size:larger"><b>Your payment option is: Credit Card</b></span><br /><br />
            CCS accepts payments by Visa or Mastercard. Download and print the <a href="http://10.170.50.51:7177/InternationalStudents/TextFile.txt" target="_blank">Credit Card Authorization Form</a> and 
            <ul>
   ...
   <input type="checkbox" runat="server" name="chkOwnHousing" id="chkOwnHousing" class="oHousing" /> 
    ...
    <div class="divHideHousingAddress">
        <p>
            ...
            <asp:TextBox ID="txtUSaddress" runat="server" Columns="80" Rows="5" TextMode="MultiLine"></asp:TextBox>
        </p>
    </div>
        <script type="text/javascript">
            $(document).ready(function () {
...
-->
    ...
    <input type="radio" name="radFood" id="radFood_2" runat="server" class="foodEat" value="no" /> No
      <div class="divHideFoodEat">
        ...
        <asp:TextBox ID="txtNoFood" runat="server" Columns="80" Rows="5" TextMode="MultiLine"></asp:TextBox>
      </div>
    ...
    <p>
        ...
        **Students transferring from other U.S. schools must present their most recent I-20 instead of a CCS I-20.
        <br /><br />By checking the box below, I verify that, to the best of my knowledge, all of the statements on this form 
        are true. I have read and agree to the published International Student Admission Policies.
        <asp:CheckBox ID="chkAgree" name="chkAgree" runat="server" BackColor="ControlLight" Text="&nbsp;&nbsp;All statements are true and I agree to the policies *" Width="100%" />
        <br /><br /></div>
    </p> 
    <div id="eAgree" class="divError" runat="server">
    </div>  
