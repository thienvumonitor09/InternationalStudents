<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/internationalGlobal2subpage.master" CodeFile="iStudentReportAll.aspx.cs" Inherits="InternationalStudents_Standardized_iStudentReportAll" MaintainScrollPositionOnPostback="true" %>
...
<table width="100%">
    ...
    <tr>
        ...
        <td align="right" valign="top"><a href="iStudentReports.aspx">Return to Summary</a></td>
    </tr>
    <tr>
        <td align="left">Enter new SID: <asp:TextBox ID="txtSID" runat="server"></asp:TextBox></td>
...
<table width="100%" id="personalI" runat="server" class="position">
    ...
    <tr>
        <th align="left" style="width:25%;">Special accommodations:</th>
