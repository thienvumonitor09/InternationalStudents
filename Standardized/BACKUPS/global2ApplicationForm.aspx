<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/internationalGlobal2subpage.master" CodeFile="global2ApplicationForm.aspx.cs" Inherits="InternationalStudents_Standardized_global2ApplicationForm" %>
...
<script type="text/javascript">
  ...
  <!--  <fieldset id="current" runat="server" visible="true" width="100%" title="application form" border="0"> -->
    ...
    <table width="100%">
        <tr>
            <td style="width:35%;"><label for="txtTOEFLschoolCode" id="schoolCode">School Code</label></td>
            <td style="width:15%;"><label for="txtTOEFLscore" id="toeflScore">TOEFL Score</label></td>
            <td style="width:50%;"><label for="ddTOEFLmm" id="toeflDate">TOEFL Test Date</label></td>
        </tr>
        <tr>
            <td style="width:35%;"><asp:TextBox ID="txtTOEFLschoolCode" onblur="checkCode()" runat="server" Width="50px" CssClass="flowBot2" MaxLength="4"></asp:TextBox>
            <br /><span style="font-size:x-small;">SCC code: 4739 or SFCC Code: 4752</span></td>
            <td style="width:15%;" valign="top"><asp:TextBox ID="txtTOEFLscore" runat="server" Width="50px" MaxLength="2" CssClass="flowBot2"></asp:TextBox></td>
            <td style="width:50%;" valign="top"><asp:DropDownList ID="ddTOEFLmm" runat="server" CssClass="flowBot2">
        ...
        <tr>
            ...
            <td style="width:15%;"><label for="txtIELTSscore" id="IELTSscore">IELTS Score</label></td>
            <td style="width:50%;"><label for="ddTOEFLmm" id="labelTOELF">IELTS Test Date</label></td>
        </tr>
        <tr>
            <td style="width:35%;"></td>
            <td style="width:15%;"><asp:TextBox ID="txtIELTSscore" runat="server" Width="50px"></asp:TextBox></td>
...
-->
    ...
    <br /><br />
        ...
        **Students transferring form other U.S. schools must present their most recent I-20 instead of a CCS 1-20, as well as <a href="https://portal.ccs.spokane.edu/_netapps/internationalsa/Transfer_IN.pdf" target="_blank">this Transfer In (Status Verification) form</a>.
    ...
    <p>
        <label for="chkHowFindCCS" id="lblHowFindCCS" class="fieldTitle">How did you find out about CCS?</label><br />
        <asp:CheckBoxList ID="chkHowFindCCS" runat="server" RepeatDirection="Horizontal" style="margin-right:0px" width="600px" RepeatLayout="Flow" CssClass="flowBot">
            <asp:ListItem Value="Referral">Referral from friend/family</asp:ListItem>
            <asp:ListItem>Agent</asp:ListItem>
            <asp:ListItem>Online</asp:ListItem>
            <asp:ListItem>StudyUSA</asp:ListItem>
            <asp:ListItem>Zinch</asp:ListItem>
        </asp:CheckBoxList>
    </p>  
