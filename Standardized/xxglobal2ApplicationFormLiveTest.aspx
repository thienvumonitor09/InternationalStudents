<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TuneUpTEST.master" CodeFile="xxglobal2ApplicationFormLiveTest.aspx.cs" Inherits="InternationalStudents_Standardized_xxglobal2ApplicationFormLiveTest" %>

<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" Runat="Server">
     <script src="https://portal.ccs.spokane.edu/_netapps/internationalsa/Scripts/jquery-1.9.1.min.js" type="text/javascript"></script>
    <script src="https://portal.ccs.spokane.edu/_netapps/internationalsa/Scripts/jquery.validate.js" type="text/javascript"></script>
    <script src="https://portal.ccs.spokane.edu/_netapps/internationalsa/Scripts/additional-methods.js" type="text/javascript"></script>
    <script src="https://portal.ccs.spokane.edu/_netapps/internationalsa/Scripts/formRulesTEST.js" type="text/javascript"></script>
   <style type="text/css">
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
    ...
    <h2><b>Application Form</b></h2>
        ...
        <asp:TextBox Width="300px" ID="txtFamilyName" runat="server" BackColor="ControlLight" MaxLength="30"></asp:TextBox>
        ...
        <asp:RadioButtonList ID="radStudentStatus" name="radStudentStatus" runat="server" BackColor="ControlLight" 
    ...
    <script type="text/javascript">
     ...
     <p>
        ...
        <asp:RadioButtonList ID="radWhenStudy" runat="server" BackColor="ControlLight" RepeatDirection="Vertical" RepeatLayout="Flow" Width="100%" >
            <asp:ListItem>Spring/April 2017</asp:ListItem>
            <asp:ListItem>Summer/July 2017</asp:ListItem>
            <asp:ListItem>Fall/September 2017</asp:ListItem>
...
<br /><br />
    <table width="100%">
        ...
        <tr>
            ...
            <asp:CheckBoxList ID="chkWhatStudy" onclick="checkClickWhatStudy()" BackColor="ControlLight" Width="100%" RepeatDirection="Vertical" RepeatLayout="Flow" runat="server">
        ...
        <tr>
            ...
            <asp:TextBox ID="txtStudyOtherProg" runat="server" MaxLength="100" Width="300px"></asp:TextBox>
        </td>
        </tr>
    </table>
    <div class="divHideTR">
    ...
    <p>
        ...
        <asp:DropDownList ID="ddMajor" runat="server" BackColor="ControlLight">
   ...
   <asp:TextBox ID="txtOtherMajor" runat="server" MaxLength="75" Width="300px"></asp:TextBox>
   </p>
   <div id="eWhatMajor" class="divError" runat="server"></div>
    ...
    <p>
        ...
        If you are sponsored, complete this <a href='http://www.ccs.spokane.edu/GlobalEducation/Files/Affidavit-of-Financial-Support.aspx' target='_blank'>Affidavit of Financial Support</a>
        <asp:CheckBoxList ID="chkHowPay" onclick="checkClickPay()" runat="server" RepeatDirection="Vertical" RepeatLayout="Flow" BackColor="ControlLight" Width="100%">
    ...
    <p>
        ...
        <asp:TextBox ID="txtOtherFinancing" runat="server" MaxLength="150" TextMode="MultiLine" Columns="60" Rows="4"></asp:TextBox>
    </p>
    ...
    <br /><br />
        ...
        **Students transferring from another U.S. school must submit their most recent I-20 as well as <a href="https://portal.ccs.spokane.edu/_netapps/internationalsa/Transfer_IN.pdf" target="_blank">this Transfer In (Status Verification) form</a>.
        <br /><br />
        <asp:CheckBox ID="chkAgree" runat="server" BackColor="ControlLight" Text="&nbsp;&nbsp;By checking this box, I verify that, to the best of my knowledge, all the statements on this form are true." Width="100%" />
